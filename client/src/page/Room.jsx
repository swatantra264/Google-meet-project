        ...
        <AnimatePresence>
          {loading ? (
            ...
            user && (
              <motion.div
                layout
                className="flex flex-row bg-[#ecfeff] text-white w-full"
              >
                <motion.div
                  layout
                  className="flex flex-col bg-[#bfdbfe] justify-between w-full"
                >
                  <div
                  ...
                  <div className="w-full h-16 bg-[#ecfeff] border-t-2 border-lightGray p-3">
