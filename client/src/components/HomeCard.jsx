  ...
  return (
    ...
    >
      <div className="flex md:h-full items-center md:flex-col md:items-start md:justify-between gap-2">
        <div
          className={`text-black text-2xl aspect-square md:h-12 flex items-center justify-center md:text-3xl 
        ...
        <div className="flex-shrink-0 md:mb-5">
          <p className="text-black   md:mb-1 text-sm md:text-2xl md:font-bold">
            {title}
          </p>
