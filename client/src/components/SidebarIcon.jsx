...
const SideBarIcon = ({ icon, text }) => (
  ...
  >
    {icon}
    <span className="absolute w-auto py-2 px-3 m-2 min-w-max left-12 rounded-md shadow-md bg-[#a5f3fc] text-white bg-gray-900 text-xs font-bold transition-all duration-100 scale-0 origin-left group-hover:scale-100">
      {text}
    </span>
  </div>
);
